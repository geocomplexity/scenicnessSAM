...
def main():
	oFile = open("data/shannon_index3.tsv", "w")
...
def join_tables():
	...
	print(table_org)
	file_org.close()
	file_index = open("data/shannon_index3.tsv", "r")
	oFile = open("data/shannon_index_scenic3.tsv", "w")
...
def join_category():
	...
	print(table_org)
	file_org.close()
	file_index = open("data/shannon_index_scenic3.tsv", "r")
	oFile = open("data/shannon_index_scenic_category3.tsv", "w")
	for ele2 in file_index:
		data2 = ele2.rstrip().split("\t")
		print(data2)
		if data2[0] in table_org:
