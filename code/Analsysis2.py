...
def main():
	oFile = open("data/shannon_index2.tsv", "w")
...
def join_tables():
	...
	print(table_org)
	file_org.close()
	file_index = open("data/shannon_index2.tsv", "r")
	oFile = open("data/shannon_index_scenic2.tsv", "w")
...
def join_category():
	...
	print(table_org)
	file_org.close()
	file_index = open("data/shannon_index_scenic2.tsv", "r")
	oFile = open("data/shannon_index_scenic_category2.tsv", "w")
	for ele2 in file_index:
		data2 = ele2.rstrip().split("\t")
		print(data2)
		if data2[0] in table_org:
